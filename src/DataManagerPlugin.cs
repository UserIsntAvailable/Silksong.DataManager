...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
{
    /// Keeps track if a mod is required to be installed when loading save data.
    /// <see cref="ISaveDataMod{T}.IsRequired"/>
    public CG.Dictionary<string, bool> RequiredMods { get; set; } = [];
}
